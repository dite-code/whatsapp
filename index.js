...
const vcard = 'BEGIN:VCARD\n' 
            + 'VERSION:3.0\n' 
            + 'FN:TermuxNesia\n' 
            + 'ORG: Pengembang TNBOT;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6281226757660:+62 812-2675-7660\n' 
            + 'END:VCARD' 
prefix = '#'
blocked = []          
...
client.on('qr', qr => {
   ...
   console.log(`[ ${time} ] QR code is ready, subrek dulu yak TermuxNesia`)
})
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		...
		try {
			...
			const ownerNumber = ["6281226757660@s.whatsapp.net"] 
          ...
          case 'ping':
            ...
            case 'kangcopet':
                ...
                case 'bug':
                    ...
                    client.sendMessage('6281226757660@s.whatsapp.net', options, text, {quoted: mek})
